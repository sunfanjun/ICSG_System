<template>
  <el-card>
    <div style="margin: 10px 0">
      ...
      <el-select v-model="aid" filterable placeholder="请选择区域" @change="handleSelectionChange">
        <el-option
      ...
      <el-input style="width: 180px" placeholder="请输入事件类型" suffix-icon="el-icon-tickets" class="ml-5" v-model="type"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 180px" placeholder="请输入处理人姓名" suffix-icon="el-icon-tickets" class="ml-5" v-model="pName"></el-input>
    ...
    <el-tabs type="card">
      <div>
        <el-table :data="tableData" border stripe :header-cell-class-name="headerBg">
          ...
          <el-table-column prop="cTime" label="处理时间"></el-table-column>
